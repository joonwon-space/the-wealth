...
import { BarChart3, BookOpen, CalendarRange, Home, LogOut, Menu, Moon, Settings, Sun, TrendingUp, Wallet, X } from "lucide-react";
...
const navItems = [
  ...
  { href: "/dashboard/annual-returns", label: "연간 수익률", icon: CalendarRange },
  { href: "/dashboard/simulation", label: "자산 시뮬레이션", icon: TrendingUp },
