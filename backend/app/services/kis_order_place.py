...
# Overseas TR_IDs — 미국주식 정규장.
# KIS는 TR ID 첫 문자로 타겟 서버를 라우팅한다 (T=실전, V=모의, H=시세).
# 'J' prefix는 존재하지 않아 EGW00356 "타겟 서버가 올바르지 않습니다" 에러가 발생한다.
_OVERSEAS_BUY_TR_ID = "TTTT1002U"
_OVERSEAS_SELL_TR_ID = "TTTT1006U"
